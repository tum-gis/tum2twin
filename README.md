...
- [sketchup-lod2-textured-models-projects](https://gitlab.lrz.de/tum-gis/tum2twin-datasets/-/tree/main/sketchup-lod2-textured-datasets-projects): LOD2 SketchUp projects for texturing the building models
